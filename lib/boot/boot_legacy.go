...
import (
	...
	"github.com/blue-jay/blueshift/viewfunc/link"
	"github.com/blue-jay/blueshift/viewfunc/noescape"
	"github.com/blue-jay/blueshift/viewfunc/prettytime"
	"github.com/blue-jay/blueshift/viewmodify/authlevel"
	"github.com/blue-jay/blueshift/viewmodify/flash"
	"github.com/blue-jay/blueshift/viewmodify/uri"
...
// RegisterServicesLegacy sets up all the web components.
func RegisterServicesLegacy(config *env.Info) {
